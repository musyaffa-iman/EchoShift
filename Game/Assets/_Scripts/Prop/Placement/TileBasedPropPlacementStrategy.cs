...
public class TileBasedPropPlacementStrategy : IPropPlacementStrategy
{
    ...
    public TileBasedPropPlacementStrategy(PropPlacer propPlacer, HashSet<Vector2Int> availableTiles, PlacementOriginCorner placementCorner)
    {
